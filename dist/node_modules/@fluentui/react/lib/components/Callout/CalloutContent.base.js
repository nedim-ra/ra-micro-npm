...
import { classNamesFunction as be } from "../../../../utilities/lib/classNamesFunction.js";
import { getPropsWithDefaults as ye } from "../../../../utilities/lib/getPropsWithDefaults.js";
import { useTarget as Oe } from "../../../../react-hooks/lib/useTarget.js";
import { getNativeProps as Pe, divProperties as He } from "../../../../utilities/lib/properties.js";
import { css as Fe } from "../../../../utilities/lib/css.js";
import { Popup as ke } from "../Popup/Popup.js";
import { shallowCompare as De } from "../../../../utilities/lib/object.js";
...
var We = /* @__PURE__ */ s.memo(s.forwardRef(function(i, r) {
  ...
  return s.createElement(
    ...
    s.createElement(
      "div",
      k({}, Pe(e, He, Te), {
        className: Fe(A.root, m && m.targetEdge && Me[m.targetEdge]),
        style: m ? k({}, K) : xe,
  ...
  return !r.shouldUpdateWhenHidden && i.hidden && r.hidden ? !0 : De(i, r);
});
function _e(i) {
