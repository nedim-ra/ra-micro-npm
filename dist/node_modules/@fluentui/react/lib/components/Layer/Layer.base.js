...
import { classNamesFunction as Q } from "../../../../utilities/lib/classNamesFunction.js";
import { usePortalCompat as X } from "../../../../react-portal-compat-context/lib/PortalCompatContext.js";
import { FocusRectsContext as Y } from "../../../../utilities/lib/useFocusRects.js";
...
import { FocusRectsProvider as $ } from "../../../../utilities/lib/FocusRectsProvider.js";
import { Fabric as ee } from "../Fabric/Fabric.js";
import { css as re } from "../../../../utilities/lib/css.js";
import { useWarnings as ne } from "../../../../react-hooks/lib/useWarnings.js";
...
var ie = /* @__PURE__ */ Q(), ue = function(e) {
  return e != null && e.current ? e.current.classList.contains(P) : !1;
}, le = /* @__PURE__ */ o.forwardRef(function(e, B) {
  var I = X(), l = o.useRef(null), x = F(l, B), u = o.useRef(), O = o.useRef(null), v = o.useContext(Y), D = o.useState(!1), p = D[0], N = D[1], S = o.useCallback(function(r) {
  ...
  return Z(function() {
    ...
    o.createElement(ee, K({}, !V && ce(), s, { className: re(h.content, s == null ? void 0 : s.className), ref: R }), T)
  ), u.current));
});
