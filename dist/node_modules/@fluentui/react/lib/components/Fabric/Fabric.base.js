...
import { getNativeProps as g, divProperties as p } from "../../../../utilities/lib/properties.js";
import { FocusRectsProvider as N } from "../../../../utilities/lib/FocusRectsProvider.js";
import { Customizer as R } from "../../../../utilities/lib/customizations/Customizer.js";
...
var C = /* @__PURE__ */ F(), P = /* @__PURE__ */ y(function(e, m) {
...
function x(e, m, r, t) {
  var a = m.root, i = e.as, d = i === void 0 ? "div" : i, n = e.dir, s = e.theme, u = g(e, p, ["dir"]), l = E(e), h = l.rootDir, T = l.needsTheme, c = o.createElement(
    N,
    { providerRef: r },
    o.createElement(d, f({ dir: h }, u, { className: a, ref: B(r, t) }))
  );
  return T && (c = // eslint-disable-next-line deprecation/deprecation
  o.createElement(R, { settings: { theme: P(s, n === "rtl") } }, c)), c;
}
function z(e, m, r) {
  var t = m.bodyThemed;
