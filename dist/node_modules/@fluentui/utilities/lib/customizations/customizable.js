import { __extends as w, __assign as r } from "../../../../tslib/tslib.es6.js";
...
import { concatStyleSets as W } from "../../../merge-styles/lib/concatStyleSets.js";
import { WindowContext as M } from "../../../react-window-provider/lib/WindowProvider.js";
import { makeShadowConfig as P } from "../../../merge-styles/lib/shadowConfig.js";
var k = /* @__PURE__ */ d(P), F = /* @__PURE__ */ d(
...
function G(s, m, y) {
  return function(c) {
    ...
    }(a.Component), l.displayName = "Customized" + s, l.contextType = M, l);
    return z(c, C);
  };
}
export {
