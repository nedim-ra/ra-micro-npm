...
import h from "../helpers/parseHeaders.js";
const b = /* @__PURE__ */ Symbol("internals");
function l(r) {
...
const d = (r) => /^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(r.trim());
...
class H {
  ...
  set(t, n, s) {
    ...
    if (i.isPlainObject(t) || t instanceof this.constructor)
      f(t, n);
    else if (i.isString(t) && (t = t.trim()) && !d(t))
      f(h(t), n);
