import me from "../models/CaseFile.js";
function Le(e, t) {
  return function() {
...
const st = v("string"), x = v("function"), Be = v("number"), G = (e) => e !== null && typeof e == "object", ot = (e) => e === !0 || e === !1, z = (e) => {
  if (K(e) !== "object")
    return !1;
  const t = ue(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, it = C("Date"), at = C("File"), ct = C("Blob"), ut = C("FileList"), lt = (e) => G(e) && x(e.pipe), ft = (e) => {
  let t;
...
const F = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, Ue = (e) => !q(e) && e !== F;
function ne() {
...
), ye = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), Pt = C("RegExp"), ke = (e, t) => {
...
}, Bt = (e, t) => e != null && Number.isFinite(e = +e) ? e : t, Z = "abcdefghijklmnopqrstuvwxyz", be = "0123456789", je = {
  DIGIT: be,
  ALPHA: Z,
...
const kt = (e) => {
  ...
  return n(e, 0);
}, jt = C("AsyncFunction"), qt = (e) => e && (G(e) || x(e)) && x(e.then) && x(e.catch), qe = ((e, t) => e ? setImmediate : t ? ((n, r) => (F.addEventListener("message", ({ source: s, data: o }) => {
  ...
  x(F.postMessage)
), It = typeof queueMicrotask < "u" ? queueMicrotask.bind(F) : typeof process < "u" && process.nextTick || qe, a = {
  isArray: U,
  isArrayBuffer: Fe,
  isBuffer: nt,
  isFormData: ft,
  ...
  function l(p, y, h) {
    ...
    if (p && !h && typeof p == "object") {
      if (a.endsWith(y, "{}"))
        ...
        return y = Me(y), w.forEach(function(S, N) {
          !(a.isUndefined(S) || S === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            i === !0 ? we([y], N, o) : i === null ? y : y + "[]",
            u(S)
          );
        }), !1;
    }
    return re(p) ? !0 : (t.append(we(h, y, o), u(p)), !1);
  }
...
}, $t = typeof URLSearchParams < "u" ? URLSearchParams : le, Vt = typeof FormData < "u" ? FormData : null, Wt = typeof Blob < "u" ? Blob : null, Kt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: $t,
    FormData: Vt,
...
}, fe = typeof window < "u" && typeof document < "u", se = typeof navigator == "object" && navigator || void 0, vt = fe && (!se || ["ReactNative", "NativeScript", "NS"].indexOf(se.product) < 0), Gt = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
...
}, Oe = (e) => (...t) => a.asap(() => e(...t)), dn = T.hasStandardBrowserEnv ? (
...
const Ge = (e) => {
  ...
  t.headers = i = A.from(i), t.url = Je(ve(t.baseURL, t.url), e.params, e.paramsSerializer), c && i.set(
    "Authorization",
  ...
  return new Promise(function(n, r) {
    ...
    }), a.isUndefined(s.withCredentials) || (h.withCredentials = !!s.withCredentials), c && c !== "json" && (h.responseType = s.responseType), u && ([b, p] = $(u, !0), h.addEventListener("progress", b)), f && h.upload && ([d, g] = $(f), h.upload.addEventListener("progress", d), h.upload.addEventListener("loadend", g)), (s.cancelToken || s.signal) && (l = (S) => {
...
}, Q = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Xe = Q && typeof ReadableStream == "function", Sn = Q && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), Qe = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
  ...
  return e && !t;
}), xe = 64 * 1024, oe = Xe && Qe(() => a.isReadableStream(new Response("").body)), V = {
  stream: oe && ((e) => e.body)
};
Q && ((e) => {
...
const Tn = async (e) => {
  ...
  try {
    ...
    let R = await fetch(p);
    const S = oe && (u === "stream" || u === "response");
    if (oe && (c || S && y)) {
      const O = {};
      ["status", "statusText", "headers"].forEach((he) => {
        O[he] = R[he];
      });
      const P = a.toFiniteNumber(R.headers.get("content-length")), [L, M] = c && Se(
        P,
        $(Oe(c), !0)
      ) || [];
      R = new Response(
...
function Ne(e) {
  return te(e), e.headers = A.from(e.headers), e.data = ee.call(
    ...
    return We(r) || (te(e), r && r.response && (r.response.data = ee.call(
      e,
      e.transformResponse,
      r.response
...
function et(e) {
  const t = new B(e), n = Le(B.prototype.request, t);
...
W.getCase = async (t, n) => {
  const r = await E.get(
    `${t}/api/akte/akte_by_nr?aktenr=${n}`
  );
  return me.mapList(r.data);
}, W.getCaseByName = async (t, n) => {
  const r = await E.get(
    `${t}/api/akte/akte1_suche?query=${encodeURIComponent(n)}&pool_id=1`
  );
  return me.mapList(r.data);
};
let _e = W;
